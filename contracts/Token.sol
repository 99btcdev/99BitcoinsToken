...
contract Token is Context, IERC20Metadata, Ownable {
  ...
  uint256 public constant presaleReserve = 29_690_100_000 * (10 ** _decimals);
  uint256 public constant stakingReserve = 13_869_900_000 * (10 ** _decimals);
  uint256 public constant projectFundsReserve = 17_820_000_000 * (10 ** _decimals);
  uint256 public constant communityRewardsReserve = 6_930_000_000 * (10 ** _decimals);
